...
import { doGetEmps, doAddEmps, doTamSalaries, doKurSalaries } from '../ReduxToolkit/EmpSlice'
                                    ...
                                    (emp || []).map(emp => {
                                        return (
                                            <tr key={emp.empId}>
                                                ...
                                                <td>
                                                    <button onClick={() => dispatch(doTamSalaries({id : emp.empId}))}> Penambahan Gaji </button>
                                                    <button onClick={() => dispatch(doKurSalaries({id : emp.empId}))}> Pengurangan Gaji</button>
                                                </td>
                                            </tr>
                                        )
                                    })
